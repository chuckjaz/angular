...
import {getAngularClassTransfomerFactory} from './r3_transform';
import {GENERATED_FILES, StructureIsReused, createMessageDiagnostic, error, isInRootDir, ngToTsDiagnostic, tsStructureIsReused, userError} from './util';
...
class AngularCompilerProgram implements Program {
  ...
  private calculateTransforms(
    ...
    if (partialModules) {
      beforeTs.push(getAngularClassTransfomerFactory(partialModules));
    }
