...
import {getAngularClassTransfomerFactory} from '../../src/transformers/r3_transform';
...
describe('r3_transform_spec', () => {
  ...
  function classMethod(
      ...
      methodName: string = 'someMethod', className: string = 'SomeClass'): o.ClassStmt {
  ...
  function emitStaticMethod(
    ...
    return emit(getAngularClassTransfomerFactory([module]));
  }
  ...
  it('should be able to a static field declaration',
  ...
  it('should be able to modify multiple class in the same module', () => {
    const result = emit(getAngularClassTransfomerFactory([{
      fileName: someGenFileName,
      statements: [
...
const FILES: Directory = {
  ...
  export class SomeClass {
    constructor(private a: stirng, private b: boolean) {}
  }
