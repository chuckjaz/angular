...
export type ParseLocation = _c.ParseLocation;
export var ParseLocation: typeof _c.ParseLocation = _c.ParseLocation;

export type ParseErrorLevel = _c.ParseErrorLevel;
export var ParseErrorLevel: typeof _c.ParseErrorLevel = _c.ParseErrorLevel;

export type ParseSourceFile = _c.ParseSourceFile;
export var ParseSourceFile: typeof _c.ParseSourceFile = _c.ParseSourceFile;

export type ParseSourceSpan = _c.ParseSourceSpan;
export var ParseSourceSpan: typeof _c.ParseSourceSpan = _c.ParseSourceSpan;

export type TemplateParser = _c.TemplateParser;
export var TemplateParser: typeof _c.TemplateParser = _c.TemplateParser;

export type TemplateParseResult = _c.TemplateParseResult;
